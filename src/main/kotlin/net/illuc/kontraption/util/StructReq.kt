...
class StructReq(
    ...
    fun isValidBlock(
        ...
        rotY: Int = 0, // (0, 90, 180, 270)
        rotX: Int = 0, // (0, 90, 180, 270)
        rotZ: Int = 0  // (0, 90, 180, 270)
    ): Pair<Boolean, Byte> {
        ...
        }.also { h = it.first; v = it.second; layer = it.third }
        when (rotX) {
        ...
        }.also { h = it.first; v = it.third; layer = it.second }
        when (rotZ) {
